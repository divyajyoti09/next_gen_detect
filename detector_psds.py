...
psds_from_files = {'ASharp':{'file':'./noise_curves/Asharp-asd.txt', # https://dcc.ligo.org/LIGO-T2300041
                             'is_asd':True},
                   'O5':{'file':'./noise_curves/O5StrainCurves_freqabc-asd.txt', # https://dcc.ligo.org/LIGO-T2500310
                          'is_asd':True},
    ...
    if psd_name in pycbc_psds:
        ...
        if psd_name == 'O5a':
            if psds_from_files['O5']['is_asd']:
                o5a = o5a**2
            psd_data = psd.from_numpy_arrays(o5_freq, o5a,
                                                length, delta_f, f_low)
        elif psd_name == 'O5b':
            if psds_from_files['O5']['is_asd']:
                o5b = o5b**2
            psd_data = psd.from_numpy_arrays(o5_freq, o5b,
                                                length, delta_f, f_low)
        elif psd_name == 'O5c':
            if psds_from_files['O5']['is_asd']:
                o5c = o5c**2
            psd_data = psd.from_numpy_arrays(o5_freq, o5c,
                                                length, delta_f, f_low)
